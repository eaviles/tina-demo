...
export default function FiberTest(props) {
    return (
        <Canvas shadows dpr={[1, 2]} camera={{ position: [-1, 1.5, 2], fov: 25 }}>

            <Suspense fallback={null}>
                <Noodle position-z={0} url="https://freesound.org/data/previews/545/545952_4984902-lq.mp3" />
            </Suspense>
        </Canvas>
    )
}
...
function Noodle({ url, y = 200, space = 1.8, width = 0.05, height = 0.5, obj = new THREE.Object3D(), ...props }) {
    const ref = useRef()
